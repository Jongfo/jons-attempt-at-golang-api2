...
func handlAPIigc(w http.ResponseWriter, r *http.Request) {
	...
	case "POST":
		...
		trackAdInfo = append(trackAdInfo, url)
...
func main() {
	...
	r.HandleFunc("/paragliding/api/igc", handlAPIigc)
	r.HandleFunc("/paragliding/api/igc/{ID}", handlAPIigcID)
	r.HandleFunc("/paragliding/api/igc/{ID}/{field}", handlAPIigcIDfield)
